      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col gap-6">
            <h3 className="text-2xl text-gold font-serif border-b border-white/10 pb-4">Personal Accounts</h3>
            
            <div className="glass-panel p-6 rounded-sm border-l-4 border-gold bg-gradient-to-r from-white/5 to-transparent">
              ...
              <div className="text-xs text-gold uppercase tracking-wider font-semibold hover:underline cursor-pointer">Read Full Diary →</div>
            </div>
          ...
          <div className="flex flex-col gap-6">
            <h3 className="text-2xl text-museumRed font-serif border-b border-white/10 pb-4">Loss Records</h3>
            
            <div className="glass-panel p-6 rounded-sm hover:bg-white/5 transition-colors cursor-pointer border border-white/5 hover:border-museumRed/30">
              ...
              <div className="text-xs text-museumRed uppercase tracking-wider font-semibold">View Records →</div>
            </div>
            ...
            <div className="glass-panel p-6 rounded-sm hover:bg-white/5 transition-colors cursor-pointer border border-white/5 hover:border-museumRed/30">
              ...
              <div className="text-xs text-museumRed uppercase tracking-wider font-semibold">View Database →</div>
            </div>
          </div>
